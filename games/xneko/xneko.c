 ...
 *!!!!!!!!F0$9$k$H!"$=$N$&$A%9%o%C%WNN0h$,ITB-$7$F$7$^$&$3$H$K
 *!!!!!!!!$J$k$+$b$7$l$^$;$s!#
 *
 *!!!!!J#6!K;~4V$KF14|$7$FI,$:IA2h=hM}$r<B9T$9$k$?$a!"0BDj>uBV
 *!!!!!!!!$G$b Idle 90 !A 95% $H$J$j!"%7%9%F%`#C#P#U$r 5 !A 10%
 ...
 *!!System (Machine):
 *
 *!!!!K\@(#)xneko.c	5.1m%0%i%`$NF0:n$r3NG'$7$?%7%9%F%`9=@.$O0J2<$NDL$j!#
 *
...
/*
 *	X11 G- C%H%^%C@(#)xneko.c	5.1U%!%$%k0lMw!'
 *
 *		"icon.xbm"		!D!!%"%$%3%s
 *		"cursor.xbm"		!D!!%+!<%=%k
...
#define	WINDOW_WIDTH		320	/* %&%#%s5.1&$NI} (%T%/%;%k) */
#define	WINDOW_HEIGHT		256	/* %&%#%s5.1&$N9b$5 (%T%/%;%k) */
...
/*--------------------------------------------------------------
 *
 *	G-0\F0%F%9%H!J05/22/91P%C%0MQ!K
 *
 *--------------------------------------------------------------*/
...
NekoMoveTest()
{
    ...
    fprintf( stderr, "\n" );
    fprintf( stderr, "\t%-!<C%I>e$N%F%s%-!<$GG-$r0\F0$5$;$F2<$5$$!#\n" );
...
ProcessDebugMenu()
{
    ...
    fprintf( stderr, "\n" );
    fprintf( stderr, "!Zxneko 05/22/91P%C%0%a%K%e!<![\n" );
